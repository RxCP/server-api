...
export class Char {
  ...
  @Column('tinyint', { name: 'char_num', width: 1, default: () => '0' })
  charNum: boolean;
  ...
  @Column('varchar', { name: 'last_map', length: 11, default: () => '' })
  lastMap: string;
  ...
  @Column('varchar', { name: 'save_map', length: 11, default: () => '' })
  saveMap: string;
  ...
  @Column('int', { name: 'moves', unsigned: true, default: () => '0' })
  moves: number;
